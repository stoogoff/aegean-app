<template>
	<ul class="flex flex-col md:flex-row md:ml-auto relative py-4 md:py-0">
		<li
			...
			class="group"
		>
			<nuxt-link :to="item.href" class="no-link">
			...
			>
				...
				>
					<nuxt-link class="block pl-12 p-1 md:px-3 min-w-full md:hover:text-gray-800 md:hover:bg-gray-200 no-link" :to="subitem.href">{{ subitem.title }}</nuxt-link>
				</li>
			</ul>
		</li>
	</ul>
